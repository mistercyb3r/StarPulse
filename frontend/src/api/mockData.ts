...
export function generateMockLocationSettings(): LocationSettingsResponse {
  return {
    ...
    active_source_label: "Manual configuration",
    active_latitude: 52.4128,
    active_longitude: 0.7471,
    place_name: "Thetford, GB",
    accuracy: null,
    approximate: false,
    weather_ok: true,
    weather_summary: "Partly cloudy",
    dish_gps_available: false,
    dish_latitude: null,
    dish_longitude: null,
    manual_latitude: 52.4128,
    manual_longitude: 0.7471,
    gps_valid: true,
    gps_enabled: true,
    gps_satellites: 14,
    advanced_note: "Starlink GPS locked but coordinates unavailable",
    message: null,
    privacy_note:
